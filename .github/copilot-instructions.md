# Precio Justo - Instrucciones para Asistente de Codificación IA
...
- **Móvil**: Capacitor v8 para builds Android/iOS
...
- `android/` - Proyecto Capacitor Android</content>
  <parameter name="filePath">c:\Z-Programacion\Quasar\PrecioJusto\.github\copilot-instructions.md
