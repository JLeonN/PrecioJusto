# PLAN DE TRABAJO - SECCIÓN COMERCIOS
...
Este plan detalla la implementación completa de la nueva sección "COMERCIOS" 
en la aplicación Precio Justo. El objetivo principal es crear una base de 
datos maestra de comercios que elimine duplicados y mejore la calidad de 
los datos ingresados por los usuarios.

### OBJETIVOS PRINCIPALES:
- Centralizar la gestión de comercios en una sección dedicada
- Eliminar duplicados mediante validación inteligente (3 niveles)
- Mejorar la experiencia al agregar precios con autocompletado
- Ordenar comercios/direcciones por últimos usados
- Reutilizar sistema de selección múltiple para eliminar comercios

### CARACTERÍSTICAS CLAVE:
- Validación de duplicados por nombre + dirección
- Algoritmo de similitud de texto (Levenshtein distance)
- Normalización automática (minúsculas, tildes, abreviaturas)
- Autocompletado inteligente ordenado por uso reciente
- Tarjetas estilo "carta vertical" responsivas
- Soporte para múltiples direcciones por comercio
- Placeholder para foto del comercio (cámara en fase futura)
- Eliminación con motivo (cerró/duplicado/otro)
...
## ✅ FASE 1: BASE DE DATOS Y SERVICIOS ⚙️ [COMPLETADA]
...
[x] Implementar normalizar() (minúsculas, tildes, espacios)
[x] Implementar similitudTexto() (Levenshtein distance)
[x] Implementar expandirAbreviaturas()
[x] Implementar registrarUsoComercio() (para orden últimos usados)
...
[x] Método eliminarComercios() (eliminación múltiple)
[x] Método agregarDireccion() en store
[x] Método eliminarDireccion() en store
[x] Método registrarUso() en store
[x] Método validarDuplicados() en store
[x] Getters: comerciosPorUso, totalComercios, totalDirecciones, comerciosPorTipo

═══════════════════════════════════════════════════════════════

## ✅ FASE 2: ESTRUCTURA DE ARCHIVOS 📁 [COMPLETADA]
...
## ✅ FASE 3: UI - PÁGINA DE COMERCIOS 🎨 [COMPLETADA]

### ComerciosPage.vue
[x] Crear estructura básica del layout
[x] Importar ListaComercios
[x] Implementar carga de comercios desde store
[x] Agregar botón FAB para nuevo comercio
[x] Implementar estados: cargando, vacío, error
[x] Agregar barra de búsqueda
[x] Integrar modo selección múltiple
...
[x] Manejar eventos de selección
[x] Agregar animaciones de entrada/salida

### TarjetaComercio.vue
[x] Crear estructura básica (layout vertical tipo carta)
...
[x] Agregar botón "Editar" (solo expandido)
[x] Implementar modo selección (checkbox circular)
[x] Implementar long-press (1 segundo)
[x] Agregar estilos responsivos
[x] Agregar animaciones de hover/active
[x] Implementar vibración háptica (Capacitor)

═══════════════════════════════════════════════════════════════

## ✅ FASE 4: FORMULARIOS Y VALIDACIONES 📝 [COMPLETADA]
...
[x] Campo: Calle y número (q-input obligatorio)
[x] Campo: Barrio (q-input opcional)
[x] Campo: Ciudad (q-input opcional)
[x] Botón placeholder cámara (deshabilitado por ahora)
[x] Implementar validaciones básicas
[x] Implementar validación de duplicados (al escribir)
[x] Mostrar feedback visual de validación
[x] Método limpiarFormulario()
[x] Método validarFormulario()
[x] Emitir evento 'guardar' con datos

### DialogoAgregarComercio.vue
[x] Crear estructura del diálogo (q-dialog)
...
[x] Cerrar diálogo después de guardar
[x] Implementar prop modelValue para v-model

### DialogoCoincidencias.vue
[x] Crear diálogo de advertencia
[x] Mostrar lista de comercios similares
[x] Mostrar porcentaje de similitud
[x] Botones: "Usar existente" / "Es nuevo, continuar"
[x] Emitir evento con decisión del usuario
[x] Diseño visual claro y amigable

### DialogoMismaUbicacion.vue
[x] Crear diálogo informativo
[x] Mostrar comercios en misma dirección
[x] Explicar que puede ser mismo edificio
[x] Botones: "Sí, agregar" / "Cancelar"
[x] Emitir evento con confirmación

### DialogoMotivoEliminacion.vue
[x] Crear diálogo de confirmación
[x] Radio buttons con opciones:
  [x] - "Cerró definitivamente"
  [x] - "Error / Duplicado"
  [x] - "Otro motivo"
[x] Campo texto para "Otro motivo"
[x] Mostrar cantidad de productos afectados
[x] Botones: "Confirmar eliminación" / "Cancelar"
[x] Emitir evento con motivo seleccionado

═══════════════════════════════════════════════════════════════

## ✅ FASE 5: INTEGRACIÓN CON PRECIOS 🔗 [COMPLETADA]

### Modificar FormularioPrecio.vue
[x] Reemplazar q-input comercio por q-select
[x] Configurar q-select con use-input
[x] Implementar @filter para búsqueda
[x] Cargar comercios desde comerciosStore.comerciosPorUso
[x] Mostrar cantidad de direcciones en cada opción
[x] Agregar opción "Agregar nuevo comercio"
[x] Reemplazar q-input dirección por q-select
[x] Cargar direcciones del comercio seleccionado
[x] Auto-seleccionar dirección más usada
[x] Detectar cuando usuario escribe dirección nueva
...
[x] Crear componente de diálogo
[x] Mostrar comercio y dirección escrita
[x] Botón: "Agregar a comercio existente"
[x] Botón: "Crear comercio nuevo"
[x] Botón: "Cancelar"
[x] Emitir eventos correspondientes
[x] Lógica de agregar dirección a existente
[x] Lógica de crear comercio nuevo
...
[x] Llamar después de guardar producto existente
[x] Llamar después de guardar producto nuevo
...
## ⏸️ FASE 6: ELIMINACIÓN MÚLTIPLE ✅ [PENDIENTE]

### Integrar selección múltiple ✅ [COMPLETADA]
[x] Verificar useSeleccionMultiple.js funciona
[x] Importar en ComerciosPage
[x] Implementar handleLongPress
[x] Implementar handleToggleSeleccion
[x] Implementar seleccionarTodos
[x] Implementar cancelarSeleccion

### Eliminar comercios con validación
[ ] Abrir DialogoMotivoEliminacion
[ ] Validar si comercios tienen productos asociados
[ ] Mostrar advertencia si tienen productos
[ ] Según motivo:
  [ ] - Cerró: Marcar productos (mantener historial)
  [ ] - Duplicado: Reasignar a otro comercio
  [ ] - Otro: Mantener precios con nombre original
[ ] Implementar eliminación con animación
[ ] Notificación con botón "Deshacer" (5 seg)
[ ] Restaurar si elige deshacer

═══════════════════════════════════════════════════════════════

## ✅ FASE 7: ROUTER Y NAVEGACIÓN 🗺️ [COMPLETADA]

### Actualizar routes.js
[x] Agregar ruta /comercios
[x] Configurar ComerciosPage como componente
[x] Verificar navegación desde drawer

### Actualizar MainLayout.vue
[x] Verificar que el item "Comercios" tenga to="/comercios"
[x] Confirmar que funciona la navegación

═══════════════════════════════════════════════════════════════

## ✅ FASE 7.5: SISTEMA DE DISEÑO CSS 🎨 [COMPLETADA - NUEVA FASE]
...
[x] Consistencia visual entre páginas
[x] Mantenimiento centralizado
[x] Base para Design System completo

═══════════════════════════════════════════════════════════════

## ✅ FASE 8: TESTING Y AJUSTES 🧪 [COMPLETADA]

### Testing funcional
[x] Crear comercio nuevo
[x] Editar comercio existente
[x] Agregar dirección a comercio
[x] Eliminar dirección de comercio
[x] Validación de duplicados exactos
[x] Validación de direcciones similares
[x] Validación de misma ubicación
[x] Búsqueda de comercios
[x] Filtrado en tiempo real
[x] Orden por últimos usados
[x] Selección múltiple
[x] Eliminación con motivo
[x] Integración con FormularioPrecio
...
### Optimizaciones
[x] Revisar performance de búsqueda
[x] Optimizar re-renders
[x] Verificar memoria (no memory leaks)
[x] Lazy loading de imágenes (futuro)

### Testing adicional completado ✅
[x] Guardar y persistir en Capacitor Storage
[x] Listar comercios guardados después de recargar
[x] Expandir/colapsar tarjetas
[x] Expansión flotante sin mover otras tarjetas
...
[x] Headers consistentes entre páginas
[x] Grid responsivo en todos los breakpoints

### Testing de Sistema de Diseño ✅
[x] Clase .contenedor-pagina funciona en ambas páginas
...
## ⏸️ FASE 9: DOCUMENTACIÓN 📚 [PENDIENTE]

### Actualizar Resúmenes
[x] Actualizar Resumen1General.txt (Sistema de Diseño agregado)
[x] Actualizar PlanTrabajoComercio.txt (este archivo)
[ ] Crear Resumen5Comercios.txt (pendiente)
[ ] Actualizar Resumen4FormularioAgregar.txt (integración)

### Comentarios en código
[ ] Documentar funciones complejas
[ ] Agregar JSDoc donde sea necesario
[ ] Comentar algoritmos de validación
...
- Fase 3 (UI Página) ✅ COMPLETADA
- Fase 4 (Formularios) ✅ COMPLETADA
- Fase 7 (Router) ✅ COMPLETADA
- Fase 7.5 (CSS) ✅ COMPLETADA (nueva fase)
- Fase 8 (Testing) 🚧 50% COMPLETADA
- No implementar cámara todavía (placeholder solamente)
- Reutilizar componentes de selección múltiple ✅ HECHO
- Mantener consistencia con diseño actual ✅ HECHO
- Sistema de diseño centralizado ✅ IMPLEMENTADO
...
### Sistema de Diseño Centralizado (Fase 7.5)
[x] Clases CSS globales en app.css
[x] Contenedor de página reutilizable
[x] Headers estandarizados
[x] Buscador centrado estilo Google
[x] Grid responsivo Quasar
[x] Variables CSS centralizadas
[x] Documentación de clases globales

### Optimizaciones de UX
[x] Expansión flotante en TarjetaComercio
[x] Bordes continuos al expandir
...
[ ] Verificación de comercios (badges)
...
✅ Fase 4: 100%
✅ Fase 5: 100%
✅ Fase 6: 100% (Eliminación múltiple - feature opcional)
✅ Fase 7: 100%
✅ Fase 7.5: 100%
✅ Fase 8: 100%
✅ Fase 9: 100%
