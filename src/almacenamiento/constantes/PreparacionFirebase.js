...
export const COLECCIONES_FIRESTORE_FUTURAS = Object.freeze({
  ...
  mesaTrabajoPrivada: 'usuarios/{usuarioId}/mesaTrabajo/items',
...
export const RUTAS_FIRESTORE_PRIVADAS = Object.freeze({
  ...
  mesaTrabajo: 'usuarios/{usuarioId}/mesaTrabajo',
  mesaTrabajoItems: 'usuarios/{usuarioId}/mesaTrabajo/items',
  mesaTrabajoItem: 'usuarios/{usuarioId}/mesaTrabajo/items/{itemId}',
