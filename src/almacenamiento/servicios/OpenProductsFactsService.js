// Servicio Open Products Facts API — productos generales (limpieza, hogar, etc.)

import axios from 'axios'

class OpenProductsFactsService {
  constructor() {
    this.baseURL = 'https://world.openproductsfacts.org/api/v2'
  }
...
export default new OpenProductsFactsService()
